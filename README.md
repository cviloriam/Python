...
⚠️ Nota: El archivo cv05_variables_tiposdedatos.py utiliza input(), por lo que requerirá interacción del usuario en la consola.
```
---
...
**Carlos Antonio Viloria Madera** (V)
